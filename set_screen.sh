...
__get_inner_view() {
    case "$MODE" in
        ...
        LR) echo "--output $INNER_PORT --mode 1920x1080";;
...
__get_outer_view() {
    ...
    case "$MODE" in
        ...
        LR) echo "--output $outport --mode 3840x2160 --scale 0.9999x0.9999 --pos 0x0 --primary" ;;
...
two() {
    ...
    xrandr $(__get_off_views) $(__get_outer_view $OUTPORT_CONNECTED)
    __setbg
}
